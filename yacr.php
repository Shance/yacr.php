...
class YacrManager extends JApplicationWeb
{
    ...
    protected function getIconByExt($ext)
    {
        if (isset($this->file_ext_icons[$ext]))
        {
            return $this->file_ext_icons[$ext];
        }

        return $this->file_ext_icons['__default'];
    }
}
...
$yam = YacrManager::getInstance('YacrManager');
